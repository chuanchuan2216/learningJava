package oods4e.ch10.apps;

import oods4e.ch02.stacks.LinkedStack;
import oods4e.ch02.stacks.StackInterface;
...
import oods4e.ch10.graphs.WeightedGraph;
import oods4e.ch10.graphs.WeightedGraphInterface;
...
public class UseGraph {
    private static void shortestPaths(WeightedGraphInterface<String> graph, String startVertex) {
        ...
        PriQueueInterface<Flight> pq = new HeapPriQ<>(20);
        String vertex;
        QueueInterface<String> vertexQueue = new LinkedQueue<>();
